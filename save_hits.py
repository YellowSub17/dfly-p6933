...
if __name__=='__main__':
    ...
    worker_t = np.array_split(t, mpi_size)[mpi_rank]
    worker_p = np.array_split(p, mpi_size)[mpi_rank]
    worker_i = np.array_split(inds, mpi_size)[mpi_rank]



    for ind, tid, pid in zip(worker_i, worker_t, worker_p) :
